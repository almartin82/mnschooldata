...
majority-Hispanic, and tribal schools that are 96% Native American.

Part of the [njschooldata](https://github.com/almartin82/njschooldata)
family.

**[Full documentation](https://almartin82.github.io/mnschooldata/)** –
...
|--------------------|-----------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------|
| **Enrollment**     | 2007-2024 | [`fetch_enr()`](https://almartin82.github.io/mnschooldata/reference/fetch_enr.md) / [`fetch_enr_multi()`](https://almartin82.github.io/mnschooldata/reference/fetch_enr_multi.md)                               | State, district, school. Race, gender, FRPL, SpEd, LEP |
| Assessments        | –         | –                                                                                                                                                                                                               | Not yet available                                      |
| Graduation         | –         | –                                                                                                                                                                                                               | Not yet available                                      |
| **Directory**      | Current   | [`fetch_directory()`](https://almartin82.github.io/mnschooldata/reference/fetch_directory.md) / [`fetch_district_directory()`](https://almartin82.github.io/mnschooldata/reference/fetch_district_directory.md) | School, district. Principal, superintendent contacts   |
...
> taxonomy](https://almartin82.github.io/mnschooldata/DATA-CATEGORY-TAXONOMY.md)
...
trends](https://almartin82.github.io/mnschooldata/articles/enrollment_hooks.html)
– 15 stories - [Function
reference](https://almartin82.github.io/mnschooldata/reference/)
