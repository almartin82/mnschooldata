...
Python wrapper for Minnesota school enrollment data.

This is a thin rpy2 wrapper around the [mnschooldata](https://github.com/almartin82/mnschooldata) R package. It provides the same functionality but returns pandas DataFrames.

## Requirements

- Python 3.9+
- R 4.0+
- The `mnschooldata` R package installed
